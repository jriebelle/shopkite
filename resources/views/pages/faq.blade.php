...
<main class="faq-page-wrapper">
        ...
        <nav class="faq-tree-nav">
            <div class="faq-tree-group open" data-category="getting-started">
                <div class="faq-tree-header" data-tooltip="Getting Started">
                    <div class="faq-nav-icon">
                        <img src="{{ asset('img/faq/getting-started.jpg') }}" alt="Getting Started" width="22" height="22">
                    </div>
            ...
            <div class="faq-tree-group " data-category="sales">
                <div class="faq-tree-header" data-tooltip="Sales">
                    <div class="faq-nav-icon">
                        <img src="{{ asset('img/faq/sales-icon.jpg') }}" alt="Sales" width="22" height="22">
                    </div>
            ...
            <div class="faq-tree-group " data-category="products">
                <div class="faq-tree-header" data-tooltip="Products & Inventory">
                    <div class="faq-nav-icon">
                        <img src="{{ asset('img/faq/products-inventory.jpg') }}" alt="Products & Inventory" width="22" height="22">
                    </div>
            ...
            <div class="faq-tree-group " data-category="customer">
                <div class="faq-tree-header" data-tooltip="Customer Management">
                    <div class="faq-nav-icon">
                        <img src="{{ asset('img/faq/customer.jpg') }}" alt="Customer Management" width="22" height="22">
                    </div>
            ...
            <div class="faq-tree-group " data-category="delivery">
                <div class="faq-tree-header" data-tooltip="Delivery & Orders">
                    <div class="faq-nav-icon">
                        <img src="{{ asset('img/faq/delivery-orders.jpg') }}" alt="Delivery & Orders" width="22" height="22">
                    </div>
            ...
            <div class="faq-tree-group " data-category="supply">
                <div class="faq-tree-header" data-tooltip="Supply & Restocking">
                    <div class="faq-nav-icon">
                        <img src="{{ asset('img/faq/supply.jpg') }}" alt="Supply & Restocking" width="22" height="22">
                    </div>
            ...
            <div class="faq-tree-group " data-category="expenses">
                <div class="faq-tree-header" data-tooltip="Expenses">
                    <div class="faq-nav-icon">
                        <img src="{{ asset('img/faq/expenses.jpg') }}" alt="Expenses" width="22" height="22">
                    </div>
            ...
            <div class="faq-tree-group " data-category="stores">
                <div class="faq-tree-header" data-tooltip="Stores, Warehouses & Staff">
                    <div class="faq-nav-icon">
                        <img src="{{ asset('img/faq/stores-warehouses-staff.jpg') }}" alt="Stores, Warehouses & Staff" width="22" height="22">
                    </div>
            ...
            <div class="faq-tree-group " data-category="general">
                <div class="faq-tree-header" data-tooltip="General Settings & Data">
                    <div class="faq-nav-icon">
                        <img src="{{ asset('img/faq/general-settings.jpg') }}" alt="General Settings & Data" width="22" height="22">
                    </div>
            ...
            <div class="faq-tree-group " data-category="extras">
                <div class="faq-tree-header" data-tooltip="Extras & App Info">
                    <div class="faq-nav-icon">
                        <img src="{{ asset('img/faq/extras-app.jpg') }}" alt="Extras & App Info" width="22" height="22">
                    </div>
    ...
    <section class="faq-main-content">
        ...
        <section class="faq-category-section" id="getting-started">
            <h2 class="faq-category-header">
                <span class="faq-cat-icon">
                    <img src="{{ asset('img/faq/getting-started.jpg') }}" alt="Getting Started" width="34" height="34">
                </span>
                Getting Started
            </h2>
        ...
        <section class="faq-category-section" id="sales">
            <h2 class="faq-category-header">
                <span class="faq-cat-icon">
                    <img src="{{ asset('img/faq/sales-icon.jpg') }}" alt="Sales" width="34" height="34">
                </span>
                Sales
            </h2>
            <div class="faq-accordion-group">
        ...
        <section class="faq-category-section" id="products">
            <h2 class="faq-category-header">
                <span class="faq-cat-icon">
                    <img src="{{ asset('img/faq/products-inventory.jpg') }}" alt="Products & Inventory" width="34" height="34">
                </span>
                Products & Inventory
            </h2>
            <div class="faq-accordion-group">
        ...
        <section class="faq-category-section" id="customer">
            <h2 class="faq-category-header">
                <span class="faq-cat-icon">
                    <img src="{{ asset('img/faq/customer.jpg') }}" alt="Customer Management" width="34" height="34">
                </span>
                Customer Management
            </h2>
            <div class="faq-accordion-group">
        ...
        <section class="faq-category-section" id="delivery">
            <h2 class="faq-category-header">
                <span class="faq-cat-icon">
                    <img src="{{ asset('img/faq/delivery-orders.jpg') }}" alt="Delivery & Orders" width="34" height="34">
                </span>
                Delivery & Orders
            </h2>
            <div class="faq-accordion-group">
        ...
        <section class="faq-category-section" id="supply">
            <h2 class="faq-category-header">
                <span class="faq-cat-icon">
                    <img src="{{ asset('img/faq/supply.jpg') }}" alt="Supply & Restocking" width="34" height="34">
                </span>
                Supply & Restocking
            </h2>
            <div class="faq-accordion-group">
        ...
        <section class="faq-category-section" id="expenses">
            <h2 class="faq-category-header">
                <span class="faq-cat-icon">
                    <img src="{{ asset('img/faq/expenses.jpg') }}" alt="Expenses" width="34" height="34">
                </span>
                Expenses
            </h2>
            <div class="faq-accordion-group">
        ...
        <section class="faq-category-section" id="stores">
            <h2 class="faq-category-header">
                <span class="faq-cat-icon">
                    <img src="{{ asset('img/faq/stores-warehouses-staff.jpg') }}" alt="Stores, Warehouses & Staff" width="34" height="34">
                </span>
        ...
        <section class="faq-category-section" id="general">
            <h2 class="faq-category-header">
                <span class="faq-cat-icon">
                    <img src="{{ asset('img/faq/general-settings.jpg') }}" alt="General Settings & Data" width="34" height="34">
                </span>
        ...
        <section class="faq-category-section" id="extras">
            <h2 class="faq-category-header">
                <span class="faq-cat-icon">
                    <img src="{{ asset('img/faq/extras-app.jpg') }}" alt="Extras & App Info" width="34" height="34">
                </span>
                Extras & App Info
            </h2>
            <div class="faq-accordion-group">
